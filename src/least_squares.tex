...
\addNote{%
\textbf{The Stability Trap:}\enspace
$\kappa_2(\bA^T\bA) = \kappa_2(\bA)^2$. Squaring the condition number can destroy precision. If $\kappa_2(\bA) = 10^6$, you may lose 12 digits of accuracy. \textbf{Practical Rule:}\enspace Avoid normal equations for ill-conditioned matrices.
}
...
\[
    \bR\hat{\bx} = \bQ^T\bb.
\]
\textbf{Why?}\enspace $\|\bA\bx - \bb\|_2^2 = \|\bR\bx - \bQ^T\bb\|_2^2 + \|(\bI - \bQ\bQ^T)\bb\|_2^2$. The first term is zeroed by the solve.
}
